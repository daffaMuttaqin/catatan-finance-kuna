...
<head>
    ...
    <div class="max-w-6xl mx-auto bg-white p-6 rounded-xl shadow">
        ...
        <!-- FORM -->
        <form method="POST" action="/expenses" class="grid grid-cols-2 gap-4 mb-6">
            @csrf
            ...
            <input type="text" name="size" placeholder="Size" class="border p-2 rounded" required>
                ...
                @foreach($expenses as $item)
                    <tr class="border-b">
                        ...
                        <td class="p-2">
                            ...
                            <form method="POST" action="/expenses/{{ $item->id }}">
                                @csrf
                                @method('DELETE')
